		...
		function Tab.Create_Section()
			...
			function Section.Create_DropToggle(options)
				...
				function Module.Create_Dropdown(self, options)
					...
					-- animate slide-down + fade-in for the dropdown header
					pcall(function()
						local tween = Ts:Create(DD.Frame, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(0, 216, 0, 27), TextTransparency = 0 })
						tween:Play()
					end)
